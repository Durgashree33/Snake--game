...
const gameBoard = document.querySelector(".board"); //game grid area
const gameRestart = document.querySelector(".reset"); //restart button
const highScoreBox = document.querySelector("#high-score"); //high scr display
const currentScoreBox = document.querySelector("#score"); //current scr display
...
//Stops the game
//Waits for reset button click to reload the page.
